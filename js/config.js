...
// ── Client Mood Options ──
var MOOD_OPTIONS = [
  { key: 'happy',   label: 'مبسوط',     emoji: '😊', cls: 'badge-mood-happy'    },
  { key: 'neutral', label: 'عادي',       emoji: '😐', cls: 'badge-mood-neutral'  },
  { key: 'unhappy', label: 'مش مبسوط',  emoji: '😞', cls: 'badge-mood-unhappy'  }
];

var CLIENT_STATUS_OPTIONS = ['New', 'Contacted', 'Interested', 'Closed'];

// Session expiry (12 hours)
var SESSION_EXPIRY_MS = 12 * 60 * 60 * 1000;
